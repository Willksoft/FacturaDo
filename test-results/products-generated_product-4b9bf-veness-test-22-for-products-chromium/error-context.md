...
- Name: products\generated_products_test_22.spec.ts >> Products Module - Test Suite 22 >> UI responsiveness test 22 for products
- Location: tests\e2e\products\generated_products_test_22.spec.ts:17:3
...
```ts
  ...
  3  | 
  4  | test.describe('Products Module - Test Suite 22', () => {
  5  |   test('Smoke test 22 for products', async ({ adminPage }) => {
  ...
  15 |   });
  16 | 
  17 |   test('UI responsiveness test 22 for products', async ({ adminPage }) => {
