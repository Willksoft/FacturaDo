...
- Name: products\generated_products_test_30.spec.ts >> Products Module - Test Suite 30 >> UI responsiveness test 30 for products
- Location: tests\e2e\products\generated_products_test_30.spec.ts:17:3
...
```ts
  ...
  3  | 
  4  | test.describe('Products Module - Test Suite 30', () => {
  5  |   test('Smoke test 30 for products', async ({ adminPage }) => {
  ...
  15 |   });
  16 | 
  17 |   test('UI responsiveness test 30 for products', async ({ adminPage }) => {
