...
- Name: dashboard\generated_dashboard_test_20.spec.ts >> Dashboard Module - Test Suite 20 >> UI responsiveness test 20 for dashboard
- Location: tests\e2e\dashboard\generated_dashboard_test_20.spec.ts:17:3
...
```ts
  ...
  3  | 
  4  | test.describe('Dashboard Module - Test Suite 20', () => {
  5  |   test('Smoke test 20 for dashboard', async ({ adminPage }) => {
  ...
  15 |   });
  16 | 
  17 |   test('UI responsiveness test 20 for dashboard', async ({ adminPage }) => {
