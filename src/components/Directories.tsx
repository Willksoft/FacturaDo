...
import { Download, Upload, Plus, Search, Trash2, Edit, FileSpreadsheet, Sparkles, Building, User, Package, Check, CheckCircle2, AlertTriangle, Loader2, Eye, Phone, Mail, MapPin, Calendar, Hash, Tag, DollarSign, Layers, Warehouse as WarehouseIcon, ShieldCheck, Globe, UserCircle } from 'lucide-react';
          ...
          <Table>
            ...
            <TableBody>
              {filteredProducts.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={8} className="text-center text-neutral-400 py-12 text-sm">
