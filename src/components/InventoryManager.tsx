...
import { Package, AlertTriangle, ArrowUpDown, TrendingDown, Sparkles, Filter, Edit, ClipboardCheck } from 'lucide-react';
...
export default function InventoryManager({
  ...
  const handleApplyAdjustment = (e: React.FormEvent) => {
    ...
    updateProduct(targetProduct.id, { stock: newStock });
  ...
  return (
    <div className="space-y-6" id="inventory-watchdog">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4" id="inventory-metrics-board">
        ...
        <Card className={`border-neutral-200 shadow-none rounded-xl ${lowStockCount > 0 ? 'bg-amber-50 border-amber-250 animate-pulse' : ''}`}>
          <CardContent className="p-4 flex items-center space-x-3">
