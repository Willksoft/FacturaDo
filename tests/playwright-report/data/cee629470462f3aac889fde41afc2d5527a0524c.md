...
- Name: dgii\generated_dgii_test_29.spec.ts >> Dgii Module - Test Suite 29 >> UI responsiveness test 29 for dgii
- Location: tests\e2e\dgii\generated_dgii_test_29.spec.ts:17:3
...
```ts
  ...
  3  | 
  4  | test.describe('Dgii Module - Test Suite 29', () => {
  5  |   test('Smoke test 29 for dgii', async ({ adminPage }) => {
  ...
  15 |   });
  16 | 
  17 |   test('UI responsiveness test 29 for dgii', async ({ adminPage }) => {
