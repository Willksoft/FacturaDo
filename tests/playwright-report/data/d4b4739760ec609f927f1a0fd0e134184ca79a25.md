...
- Name: dashboard\generated_dashboard_test_18.spec.ts >> Dashboard Module - Test Suite 18 >> UI responsiveness test 18 for dashboard
- Location: tests\e2e\dashboard\generated_dashboard_test_18.spec.ts:17:3
...
```ts
  ...
  3  | 
  4  | test.describe('Dashboard Module - Test Suite 18', () => {
  5  |   test('Smoke test 18 for dashboard', async ({ adminPage }) => {
  ...
  15 |   });
  16 | 
  17 |   test('UI responsiveness test 18 for dashboard', async ({ adminPage }) => {
