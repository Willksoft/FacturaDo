...
- Name: dashboard\generated_dashboard_test_33.spec.ts >> Dashboard Module - Test Suite 33 >> UI responsiveness test 33 for dashboard
- Location: tests\e2e\dashboard\generated_dashboard_test_33.spec.ts:17:3
...
```ts
  ...
  3  | 
  4  | test.describe('Dashboard Module - Test Suite 33', () => {
  5  |   test('Smoke test 33 for dashboard', async ({ adminPage }) => {
  ...
  15 |   });
  16 | 
  17 |   test('UI responsiveness test 33 for dashboard', async ({ adminPage }) => {
